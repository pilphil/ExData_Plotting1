...
par(mfrow = c(2,2))
plot(newdata$newx, newdata$Global_active_power, ylab="Global Active Power", xlab="", type="l")
plot(newdata$newx, newdata$Voltage, ylab="Voltage", xlab="datetime", type="l")
...
plot(newdata$newx, newdata$Global_reactive_power, ylab="Global reactive power", xlab="datetime", type="l")
dev.off()
